...
function MenuItem({ link, text, image }) {
  ...
  return (
    <div className="flex-1 relative overflow-hidden text-center shadow-[0_-1px_0_0_#fff]" ref={itemRef}>
      <p
        className="flex items-center justify-center h-full relative cursor-pointer no-underline font-poppins uppercase text-white text-4xl hover:text-[#060606] focus:text-white focus-visible:text-[#060606]"
        // href={link}
